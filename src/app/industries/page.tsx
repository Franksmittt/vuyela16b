...
export const metadata: Metadata = {
  ...
  keywords:
    'mining logistics, agricultural logistics, industry-specific logistics, chrome transport, manganese logistics, grain transport, South Africa industries',
  ...
  openGraph: {
    ...
    title: 'Industries We Serve | Vuyela Group',
    description:
      'Mining and agricultural logistics solutions across South Africa with specialized industry expertise.',
    url: 'https://vuyela.com/industries',
    siteName: 'Vuyela Group',
    images: [
      {
        url: '/images/Mining Logisticshp.jpg',
        width: 1200,
        height: 630,
        alt: 'Vuyela Group - Industries We Serve',
      },
    ],
  },
  twitter: {
    ...
    title: 'Industries We Serve | Vuyela Group',
    description:
      'Specialized logistics solutions for mining and agricultural sectors across South Africa.',
  },
};
...
const industriesPageSchema = {
  ...
  description:
    'Specialized logistics solutions for mining and agricultural sectors in South Africa.',
  url: 'https://vuyela.com/industries',
  provider: {
    '@type': 'Organization',
    name: 'Vuyela Group',
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Every industry has its rhythm. Mining operations don't move on a
            9-to-5 schedule. Agricultural harvests don't wait for convenient
            timing. We've built our expertise by deeply understanding the
            industries we know best. This isn't generic logistics. It's
            specialized knowledge. Industry-specific solutions. Partnerships
          ...
          <div className="px-6 max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 mt-4">
                We understand your sector deeply.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                <Target className="w-10 h-10 text-[#FFD700] mb-6" />
                <h3 className="text-xl font-bold text-white mb-4">
                  Industry Expertise
                </h3>
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Deep
                    Sector Knowledge
                  </li>
                  <li className="flex gap-2">
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Seasonal
                    Awareness
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Critical
                    Deadlines
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Vessel
                    Scheduling
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Harvest
                    Windows
                  </li>
                </ul>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-stretch">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                From pit to port, we know this journey intimately. Our team
                didn't learn mining logistics from manuals. They learned it on
                the ground. We handle chrome concentrate, manganese ore, and
                iron ore through every stage of the supply chain. Years of
                experience in the commodity sector means we understand what
                others miss.
              </p>
              <p className="text-gray-400 leading-relaxed mb-6">
                We understand the weight of ROM versus concentrate. We know the
                timing critical to vessel bookings. We handle the documentation
                required for international trade. When mining companies trust us
                with their ores and minerals, they're trusting partners who
                speak their language. We understand their challenges. We deliver
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto bg-[#141414] border-y border-[#1f1f1f]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-stretch">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Feeding the future means understanding timing like no other
                industry. When harvest season peaks, there's no second chance.
                Grain needs to move while it's fresh. Fertilizers must arrive
                before planting windows close. Produce can't wait for convenient
                shipping schedules.
              </p>
              <p className="text-gray-400 leading-relaxed mb-6">
                We've worked alongside farmers and agribusinesses long enough to
                understand that agricultural logistics isn't just about
                transport. It's about respecting nature's calendar. Seasonality
                isn't an inconvenience. It's the reality that shapes everything
                we do. We understand the sensitivity of agricultural products.
                We know the urgency of harvest windows. We recognize the
                critical importance of getting it right when timing matters
                most.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Yes. We handle chrome concentrate and ROM. We handle manganese
                and iron ore. We handle coal and ferroalloys. We handle
                ferrochrome and ferromanganese. Our experience covers the full
                range of mining commodities. We understand the specific
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                We plan for seasonal peaks. We scale our operations to meet
                harvest demands. We understand that timing is critical. We
                coordinate with farmers and agribusinesses. We ensure flexible
                transport solutions. We manage seasonal demand effectively.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                We specialize in mining and agricultural logistics. We don't try
                to serve everyone. We focus on what we know best. We understand
                commodity specifications. We know regulatory requirements. We
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Yes. We handle domestic transport across South Africa. We also
                manage international shipments through our freight division. We
                coordinate with shipping lines. We handle customs clearing. We
                provide complete solutions from pit to port.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Every industry has its own story. Its own challenges. Its own
            requirements. We've chosen to specialize in mining and agricultural
            logistics. We understand these sectors deeply. Let's discuss how our
            specialized expertise can become your competitive advantage.
          </p>
