...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Contact Us | Vuyela Group',
    description:
      'Reach out to discuss your logistics requirements with our expert team. 24/7 support available.',
  ...
  twitter: {
    ...
    title: 'Contact Us | Vuyela Group',
    description:
      'Contact Vuyela Group for logistics solutions. 24/7 support available.',
  },
};
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-8 tracking-tight font-poppins">
            Contact <span className="text-[#FFD700]">Vuyela Group</span>
          </h1>

          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Ready to partner with us? Contact our team. We discuss your
            logistics needs. We provide solutions. We deliver excellence. Our
            team operates 24/7. We respond quickly. We solve problems.
          </p>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Quick
                    Response Times
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Direct
                    Director Access
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Custom
                    Solutions
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Personal
                    Service
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> South
                    Africa Coverage
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" />{' '}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400 mb-8">
                  Reach out through any channel. Our team is available 24/7. We
                  respond quickly. We solve problems.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  ...
                  <div className="space-y-3">
                    <Link
                      href="/services/bulk"
                      className="flex items-center gap-3 p-3 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a] hover:border-[#FFD700]/30 transition-colors group"
                    >
                      <div className="w-10 h-10 rounded-lg bg-[#FFD700]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-white transition-colors">
                        <Warehouse className="h-5 w-5 text-[#FFD700] group-hover:text-white transition-colors" />
                      </div>
                      <div className="flex-1">
                        <p className="text-white font-medium text-sm group-hover:text-[#FFD700] transition-colors">
                          Vuyela Bulk
                        </p>
                      </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-[#141414] p-10 rounded-2xl border border-[#2a2a2a] h-full">
                ...
                <p className="text-gray-400 mb-8">
                  Fill out the form below. We'll respond within 24 hours. For
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Our Elandsfontein facility is the heart of operations. We're
                located at 83 Main Reef Road. This location gives us easy access
                to major transport routes. We're close to the Port of Durban.
                We're near TFR terminals.
              </p>
              <ul className="space-y-3 text-gray-300">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  Easy access from N3 and N12 highways
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                ...
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  Strategic position for nationwide distribution
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  Secure facility with full CCTV coverage
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                During your visit, you'll see our SOLAS certified weighbridges.
                You'll see our SARS Bonded Warehouse. You'll see container
                handling facilities. You'll see our operations center. Our team
                will walk you through everything.
              </p>
              <ul className="space-y-3 text-gray-300">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  SOLAS certified weighbridge operations
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  SARS Bonded Warehouse facilities
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#141414] p-8 rounded-xl border border-[#2a2a2a] text-center">
              ...
              <p className="text-gray-400 text-sm">
                Our facility operates around the clock. Cargo moves day and
            ...
            <div className="bg-[#141414] p-8 rounded-xl border border-[#2a2a2a] text-center">
              ...
              <p className="text-[#FFD700] text-3xl font-bold mb-2">24/7</p>
              <p className="text-gray-400 text-sm">
                Our team is always available. Emergency? Urgent shipment? We
                answer calls and emails anytime.
              </p>
            </div>
            <div className="bg-[#141414] p-8 rounded-xl border border-[#2a2a2a] text-center">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <p className="text-gray-400 text-sm">
                Schedule a visit to our facility. We'll give you a full tour.
                We'll discuss your logistics needs in person.
              </p>
            </div>
          </div>
        </section>
                ...
                <div className="space-y-1 text-sm text-gray-400">
                  {staff.email ? (
                    <a
                      ...
                      className="block hover:text-[#FFD700] transition-colors break-all"
                    >
                      {staff.email}
                    </a>
                  ) : (
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto bg-[#141414] border-y border-[#1f1f1f]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                We operate nationwide. We cover all major cities and ports. From
                Durban to Cape Town. From Johannesburg to Bloemfontein. Our
                network covers every corner of South Africa.
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-1" />{' '}
                  Port of Durban operations
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-1" />{' '}
                  TFR terminal access nationwide
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-1" />{' '}
                  Major city distribution
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-1" />{' '}
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Through our freight division, we connect South Africa to the
                world. Strategic partnerships with major shipping lines give us
                access to global routes and ports.
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-1" />{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                ...
                days. For urgent matters, we respond immediately. Our directors
                are available for direct contact. Emergency situations get
                priority attention.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Yes. Our freight division handles international shipments. We
                manage ocean freight. We handle customs clearing. We work with
                major shipping lines. We connect South Africa to the world.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                We provide four main services. Vuyela Bulk handles warehousing.
                Vuyela Logistics handles transport. Vuyela Freight handles ocean
                shipping. Vuyela Refuel handles fuel supply. We can combine
                these services for complete solutions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Join leading companies that trust Vuyela Group. Let us handle your
            logistics. You focus on your business.
          </p>
