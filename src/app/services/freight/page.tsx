...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Vuyela Freight - Ocean Freight & Customs | Vuyela Group',
    description:
      'Professional ocean freight forwarding and customs clearing services with strategic shipping line partnerships.',
  ...
  twitter: {
    ...
    description:
      'Complete freight forwarding and customs clearing with strategic shipping line partnerships.',
  },
};
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            'Global container shipping with major shipping line partnerships',
        },
      },
      {
        '@type': 'Offer',
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-8 tracking-tight font-poppins">
            Freight <span className="text-[#FFD700]">Solutions</span>
          </h1>

          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Ocean freight needs expertise. We understand routes, rates, and
            regulations. We built partnerships with major shipping lines. Years
            of reliable service created these relationships. Export chrome to
            Asia. Import machinery from Europe. Move commodities anywhere. We
            have the coverage and expertise.
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-400 leading-relaxed mb-6">
                Our freight services cover the full journey. We manage
                containers from port to delivery. Customs clearing happens
                smoothly. Documentation stays accurate. Delays get avoided. We
                work with shipping agents. Best rates and routes get secured.
                Border clearance works efficiently. Every step gets managed
                carefully.
              </p>
              <p className="text-gray-400 leading-relaxed mb-6">
                The Problem: International shipping is complex. Routes change
                constantly. Rates vary widely. Customs rules confuse many.
                Documentation errors cause delays. Many companies struggle with
                these challenges.
              </p>
          ...
          <div className="px-6 max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white">
                Why Choose Vuyela Freight
              </h2>
              <p className="text-gray-400 mt-4">
                We make international shipping simple.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Major
                    Shipping Lines
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Best
                    Rates
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Priority
                    Booking
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Fast
                    Clearance
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Correct
                    Documentation
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Border
                    Relationships
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Reduced
                    Delays
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Bills of
                    Lading
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Customs
                    Forms
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" />{' '}
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Export
                    Permits
                  </li>
                </ul>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                We work with major shipping lines worldwide. Asia, Europe,
                Americas - we have routes to every major port. Our partnerships
                mean better rates and faster transit times for you.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              <h3 className="text-xl font-bold text-white mb-4">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Customs delays cost money. Our team handles all documentation
                correctly the first time. We know what forms you need, when to
                file them, and how to avoid common mistakes.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              <h3 className="text-xl font-bold text-white mb-4">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                You talk to real people, not automated systems. Our directors
                are involved in every major shipment. When problems arise, we
                solve them fast.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Years of consistent performance built our reputation. Shipping
                lines trust us. Customs officials know us. That trust makes your
                shipments move smoother.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto bg-[#141414] border-y border-[#1f1f1f]">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3">
                Step 1: Booking & Planning
              </h3>
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                We discuss your cargo, destination, and timeline. Our team finds
                the best shipping route and rate. We book space on the vessel
                and confirm all details with you.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                We prepare all required documents. Bills of lading, customs
                forms, certificates - we handle it all. Our experience means no
                missing paperwork or delays.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                When your cargo arrives, we clear customs fast. Our
                relationships and expertise mean fewer inspections and quicker
                releases. You get your cargo when you need it.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                We coordinate final delivery to your location. Our logistics
                team ensures smooth handoff. You receive your cargo on time, in
                perfect condition.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Interlink trucks move containers. They connect to shipping
                ports. TFR terminal access works smoothly. Container handling
                stays efficient. Heavy loads move safely.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Flatbeds carry oversized cargo. Coils fit perfectly. Machinery
                moves easily. Loading stays simple. Secure strapping protects
                cargo.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Tippers handle bulk materials. Quick unloading saves time.
                Construction sites use them. Mining operations depend on them.
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                We move cargo across SADC countries. Botswana, Zimbabwe,
                Mozambique, and more. Border procedures stay familiar. We know
                the rules. Delays stay minimal.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Border crossings need correct paperwork. We prepare documents
                properly. Customs officials know us. Clearance happens fast.
                Your cargo moves quickly.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
          ...
          <div className="space-y-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                We work with major shipping lines worldwide. Our partnerships
                include Maersk, MSC, CMA CGM, and others. These relationships
                give us access to routes, rates, and priority booking that
                others can't match. We leverage these partnerships for your
                benefit.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Customs clearing time varies. Standard shipments clear within
                24-48 hours. Our expertise and relationships help speed up the
                process. We prepare all documentation correctly. We avoid common
                mistakes. This reduces delays significantly.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                Yes. We handle both imports and exports. We manage import
                containers from port to delivery. We handle export containers
                from pickup to port. We coordinate customs clearing for both
                directions. Complete solutions for international trade.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                We handle all shipping documentation. Bills of lading, customs
                declarations, certificates of origin, export permits, and more.
                Our team ensures everything is correct. We file documents on
                time. We avoid errors that cause delays.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Every international shipment is unique, different destinations,
            different cargo, different timelines. Let's discuss your specific
            requirements and explore how our shipping partnerships, customs
            expertise, and global coverage can simplify your international
            trade.
          </p>
