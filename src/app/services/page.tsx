...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Our Services | Vuyela Group',
    description:
      'Complete logistics solutions for warehousing, transport, freight, and energy needs across South Africa.',
...
const servicesPageSchema = {
  ...
  description:
    'Comprehensive logistics solutions including warehousing, freight, bulk handling, and energy solutions.',
  url: 'https://vuyela.com/services',
  provider: {
    '@type': 'Organization',
    name: 'Vuyela Group',
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-8 tracking-tight font-poppins">
            Comprehensive{' '}
            <span className="text-[#FFD700]">Logistics Services</span>
          </h1>

          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Four divisions. One mission. We keep South Africa moving. Vuyela
            Bulk handles warehousing. Vuyela Logistics runs our fleet. Vuyela
            Freight manages ocean shipping. Vuyela Refuel supplies premium
            diesel. These services work together. They create a complete
            logistics solution.
          </p>
        </section>
          ...
          <div className="px-6 max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 mt-4">
                We make logistics simple and reliable.
              </p>
            </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Four
                    Integrated Services
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> One
                    Partner
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Seamless
                    Coordination
                  </li>
                </ul>
              </div>
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="space-y-6 text-gray-300 text-lg leading-relaxed max-w-4xl mx-auto">
            <p>
              We started with one truck in 2019. Today we move millions of tons.
              Our mission is simple. We treat every shipment like our own. When
              cargo enters our facility, we become its custodian. We protect it.
              We track it. We deliver it on time.
            </p>
            <p>
              Our vision is bigger. We want to be South Africa's most trusted
              logistics partner. We combine hands-on leadership with modern
              infrastructure. We operate 24/7. We never stop moving. We never
              stop improving.
            </p>
            <p>
              Four divisions serve one purpose. They solve your logistics
              challenges. From warehousing to transport. From ocean freight to
              fuel supply. We provide complete solutions. We eliminate the need
              for multiple vendors. One partner. One point of contact. One
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                <span className="bg-[#FFD700] text-[#141414] rounded-full w-8 h-8 flex items-center justify-center font-bold">
                  1
                </span>
                Consultation & Planning
              </h3>
              <p className="text-gray-300 leading-relaxed">
                We start by understanding your needs. We discuss your cargo. We
                review your timelines. We identify challenges. Then we create a
                custom plan. This plan fits your business. It addresses your
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 leading-relaxed">
                We match your needs to our services. Need warehousing? Vuyela
                Bulk handles it. Need transport? Vuyela Logistics moves it. Need
                ocean freight? Vuyela Freight manages it. Need fuel? Vuyela
                Refuel supplies it. Often, you need multiple services. We
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 leading-relaxed">
                We execute your plan with precision. Our team handles every
                detail. We track your cargo in real-time. We monitor operations
                24/7. We update you regularly. You stay informed. You stay in
                control.
              </p>
            </div>
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 leading-relaxed">
                We deliver on time. Every time. After delivery, we follow up. We
                ensure satisfaction. We address any concerns. We learn from each
                shipment. We improve continuously. This builds long-term
                partnerships.
              </p>
            </div>
          </div>
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-[#141414] rounded-lg p-8 border border-[#2a2a2a] hover:border-[#FFD700]/50 transition-all duration-300 h-full flex flex-col"
              >
          ...
          <div className="space-y-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Yes. Many clients use multiple services. For example, you might
                need warehousing from Vuyela Bulk, transport from Vuyela
                Logistics, and ocean freight from Vuyela Freight. We coordinate
                all services seamlessly. One partner. One point of contact.
                Complete solutions.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Our facility is in Elandsfontein, South Africa. We handle
                domestic transport across the country. For international
                shipping, Vuyela Freight manages ocean freight and customs
                clearing. We work with global shipping partners. We facilitate
                trade worldwide.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                We offer four integrated services. We own our fleet. We operate
                24/7. Our directors are hands-on. We have certified
                infrastructure. We provide real-time tracking. Most importantly,
                we treat every shipment like our own. This combination is rare
                in logistics.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Contact us. We'll discuss your needs. We'll explain our
                services. We'll create a custom plan. Then we execute. It's that
                simple. No complicated processes. No long wait times. Just
                direct communication and reliable service.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Every business has unique logistics challenges. Every challenge has
            a solution. Let's discuss your needs. We'll show you how our four
