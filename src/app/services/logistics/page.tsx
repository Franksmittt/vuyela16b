...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Vuyela Logistics - Road Freight & Transport | Vuyela Group',
    description:
      'Professional road freight and transport solutions with own fleet operations and 24/7 monitoring.',
  ...
  twitter: {
    ...
    description:
      'Own fleet operations with 24/7 monitoring and reliable transport across South Africa.',
  },
};
  ...
  const features = [
    {
      ...
      description:
        "We don't outsource reliability to third-party contractors. Our own fleet means we control maintenance schedules, driver training, and vehicle standards. When you see a Vuyela truck on the road, you're seeing our commitment to quality rolling by, well-maintained, professionally driven, and mission-focused.",
    },
    {
      icon: Clock,
      title: 'Never-Stop Logistics',
      description:
        "Deadlines don't respect business hours, and neither do we. Our 24/7 operations mean your cargo moves when it needs to move, whether that's a midnight collection or a weekend delivery. With live tracking systems and full yard camera coverage, you're never in the dark.",
    },
    {
      icon: Route,
      title: 'Port Connections That Matter',
      description:
        "Moving containers to and from Durban isn't just transport, it's timing. Every day, we coordinate with port authorities, shipping lines, and terminal operators to ensure your containers arrive exactly when they need to. We understand vessel schedules, booking deadlines, and the critical timing that separates successful exports from costly delays.",
    },
    {
      icon: ShieldCheck,
      title: 'Network That Works',
      description:
        "Years of working with TFR, shipping agents, and transport partners means we've built relationships that get results. When you need a favor, when standard procedures won't work, when you're racing against a deadline, that's when our network pays dividends.",
    },
    {
      icon: MapPin,
      title: 'Everywhere You Need Us',
      description:
        "From Johannesburg to Cape Town, Durban to Bloemfontein, we cover South Africa with the same reliability wherever we operate. Our nationwide coverage doesn't mean we're spread thin, it means we've built consistent service standards that travel with our trucks.",
    },
    {
      icon: Clock,
      title: 'Time Is Money',
      description:
        "We understand this better than anyone: every hour a truck sits idle is money lost. For you and for us. That's why we've optimized our operations for speed and efficiency, from quick turnarounds at our facility to streamlined port processes.",
    },
  ];
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-8 tracking-tight font-poppins">
            Logistics <span className="text-[#FFD700]">Management</span>
          </h1>

          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Our trucks hit the road daily. We get your cargo where it needs to
            go. Timing matters. We deliver on time. Our own fleet means we
            control everything. Maintenance stays regular. Driver standards stay
            high. Reliability stays consistent.
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-400 leading-relaxed mb-6">
                We move coils to manufacturing plants. Containers race to catch
                vessel deadlines. Breakbulk cargo gets special handling. We move
                it all. Daily movements happen between Durban port and TFR
                terminals. Destinations across South Africa get covered. These
                aren't just routes. They're commitments we keep.
              </p>
              <p className="text-gray-400 leading-relaxed mb-6">
                The Problem: Road transport is unreliable. Third-party
                contractors cause delays. Maintenance gets skipped. Driver
                standards vary. Companies struggle with these issues.
              </p>
          ...
          <div className="px-6 max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white">
                Why Choose Vuyela Logistics
              </h2>
              <p className="text-gray-400 mt-4">
                We make road transport reliable.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> We Own
                    Our Trucks
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> We
                    Control Maintenance
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> We Train
                    Our Drivers
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> No
                    Third-Party Excuses
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Never
                    Stop Moving
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Weekend
                    Deliveries
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Urgent
                    Shipments
                  </li>
                  <li className="flex gap-2">
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> All
                    Major Cities
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Port
                    Connections
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> TFR
                    Terminal Access
                  </li>
                  <li className="flex gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                We own our trucks. We control maintenance, driver training, and
                vehicle standards. No third-party delays or excuses. When we
                promise delivery, we deliver.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              <h3 className="text-xl font-bold text-white mb-4">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Logistics never stops. Neither do we. Our trucks run day and
                night. Weekend deliveries? No problem. Urgent shipments? We
                handle them.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Know where your cargo is every minute. Our tracking systems show
                real-time location. No guessing, no waiting for updates.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              <h3 className="text-xl font-bold text-white mb-4">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                From Durban to Cape Town, Johannesburg to Bloemfontein. We cover
                all of South Africa with the same reliability everywhere we go.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto bg-[#141414] border-y border-[#1f1f1f]">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                You tell us what needs moving, where, and when. We confirm
                capacity and schedule. Simple booking, clear communication.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Our truck arrives on time. Driver handles loading safely. We
                verify cargo and paperwork. Then we hit the road.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Cargo moves safely to destination. You track progress in
                real-time. Our team monitors every mile. We keep you informed.
              </p>
            </div>
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                We arrive on schedule. Unload cargo carefully. Get delivery
                confirmation. Job done, promise kept.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Our warehouse keeps cargo safe. CCTV cameras watch everything.
                Access stays controlled. Security guards patrol regularly. Your
                goods stay protected day and night.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                We move cargo quickly. Trucks load fast. Routes stay optimized.
                Delivery happens on time. Speed matters to us.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Every truck has GPS. Location updates every minute. You track
                cargo in real-time. No guessing where it is.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Our app shows cargo status. Check it on your phone. Alerts
                notify you. Information stays accessible.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Cameras cover our yard. You watch cargo loading. Security stays
                visible. Operations stay transparent.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
          ...
          <div className="space-y-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Yes. We own our fleet. We don't use third-party contractors.
                This means we control maintenance, driver training, and vehicle
                standards. No excuses. No blame-shifting. Just reliable
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Yes. We operate 24/7. Urgent shipments get priority. Weekend
                deliveries work fine. We understand that timing matters. We move
                cargo when it needs to move.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                We use GPS tracking systems. Every truck has GPS. Location
                updates every minute. You can track cargo in real-time through
                our systems. We also have full yard camera coverage. You see
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                We cover all of South Africa. From Durban to Cape Town. From
                Johannesburg to Bloemfontein. We also handle cross-border
                transport into SADC countries. Our network covers major routes
                and ports.
              </p>
            </div>
          </div>
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          <h2 className="text-3xl font-bold text-white mb-6">
            Need Transport Solutions?
          </h2>
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Whether you're moving containers, coils, breakbulk, or general
            freight, every transport requirement is unique. Let's discuss your
            specific needs and explore how our fleet, our network, and our
            commitment to reliability can become your competitive advantage.
          </p>
