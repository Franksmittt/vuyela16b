...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Vuyela Refuel - Energy Solutions | Vuyela Group',
    description:
      'Quality-assured diesel supply with comprehensive testing protocols and premium 50ppm diesel.',
  ...
  twitter: {
    ...
    description:
      'Premium 50ppm diesel supply with rigorous quality testing and guaranteed pure fuel.',
  },
};
...
const refuelServiceSchema = {
  ...
  description:
    'Premium 50ppm diesel supply with rigorous quality testing. Guaranteed pure fuel with comprehensive testing protocols.',
  url: 'https://vuyela.com/services/refuel',
  provider: {
    '@type': 'Organization',
    name: 'Vuyela Group',
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            'Comprehensive fuel testing including paraffin contamination checks',
        },
      },
      {
        '@type': 'Offer',
  ...
  const features = [
    {
      ...
      description:
        "50ppm isn't just a specification - it's a commitment to cleaner emissions and better engine performance. Our diesel meets and exceeds the highest industry standards, but more importantly, it's tested before it ever reaches our storage tanks. When you see \"50ppm\" on our documentation, you can trust that it's not just a label; it's a verified standard.",
    },
    {
      icon: ShieldCheck,
    ...
    },
    {
      ...
      description:
        'Our 80,000-liter storage capacity with two pumping stations means we can handle high-volume operations without making you wait. Whether you need a single truck fill or a bulk delivery for your entire fleet, we have the capacity and the infrastructure to make it happen efficiently.',
    },
    {
      icon: Clock,
      title: 'Hours That Match Your Operations',
      description:
        "Fleet operations don't follow a 9-to-5 schedule, and neither do we. Weekdays from 06h00 to 23h00, weekends and public holidays from 07h00 to 15h00 - these aren't arbitrary hours; they're designed to match when your vehicles need fuel.",
    },
    {
      icon: Zap,
      title: 'Proven Volume Processing',
      description:
        "Currently processing 40,000 liters per week isn't just a statistic - it's proof that we can handle your volume requirements. This isn't a new operation struggling to find its footing; it's an established service that's already proven its capacity and reliability.",
    },
    {
      icon: ShieldCheck,
      title: 'Quality Gate, Not Quality Check',
      description:
        "Quality isn't something we verify after receiving fuel - it's something we test before it enters our tanks. Every delivery must pass our quality checks before we accept it. This means contaminated fuel never touches our storage, and therefore never reaches your equipment.",
    },
  ];
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-8 tracking-tight font-poppins">
            On-Site <span className="text-[#FFD700]">Refueling Services</span>
          </h1>

          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Dirty diesel destroys engines. It damages equipment. It costs money.
            We launched Vuyela Refuel in April 2024. Our principle is simple.
            Never compromise on fuel quality. This isn't just fuel supply. It's
            fuel integrity.
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-400 leading-relaxed mb-6">
                Every delivery gets tested. Our "Pregnancy Test" protocol checks
                quality. Water tests find contamination. Density tests verify
                standards. Paraffin tests detect problems. Visual inspections
                confirm clarity. All tests must pass. Fuel enters your tank only
                after passing.
              </p>
              <p className="text-gray-400 leading-relaxed mb-6">
                The Problem: Contaminated fuel shuts down operations. Equipment
                breaks. Repairs cost thousands. Many suppliers skip quality
                checks. Companies suffer the consequences.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Water
                    Contamination Tests
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Density
                    Verification
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Visual
                    Inspections
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Cleaner
                    Emissions
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Better
                    Engine Performance
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Industry
                    Standards
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Verified
                    Quality
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" />{' '}
                    Weekdays: 06h00-23h00
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" />{' '}
                    Weekends: 07h00-15h00
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Matches
                    Your Schedule
                  </li>
                  <li className="flex gap-2">
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          <div className="bg-[#141414] rounded-lg p-6 sm:p-8 border border-[#2a2a2a]">
            ...
            <p className="text-gray-400 text-sm sm:text-base text-center mb-8 max-w-2xl mx-auto">
              Our extended operating hours are designed to match your fleet's
              schedule. Whether you need early morning refueling or late evening
              service, we're here to keep your operations running.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-[#141414] rounded-lg p-6 border border-[#222] text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                On-site refueling cuts costs. Trucks don't drive to stations.
                Driver time stays productive. Fuel prices stay competitive. Bulk
                delivery saves money.
              </p>
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#222]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Trucks refuel on-site. No trips to stations. Operations keep
                running. Productivity stays high. Time waste disappears.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                Every delivery gets tested. Water tests check contamination.
                Density tests verify standards. Pregnancy tests find paraffin.
                Visual checks confirm clarity. All tests must pass.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
            ...
            <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
                We guarantee fuel quality. Contaminated fuel never ships.
                Equipment stays protected. Engines run smoothly. Problems get
                prevented.
              </p>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex gap-2">
          ...
          <div className="space-y-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                The "Pregnancy Test" is our paraffin contamination check. We
                test every fuel delivery for paraffin before it enters our
                tanks. This simple but effective test ensures contaminated fuel
                never reaches your equipment. It's called the "Pregnancy Test"
                because it detects contamination that other tests might miss.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                Weekdays: 06h00 to 23h00. Weekends and public holidays: 07h00 to
                15h00. These hours match when your fleet needs fuel. Early
                morning starts work. Late evening operations work. Weekend
                shifts work. We're here when you need us.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                We have 80,000 liters of storage capacity. Two pumping stations
                handle high volumes. We currently process 40,000 liters per
                week. Large volumes don't mean long waits. We handle bulk
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                We test every delivery before it enters our tanks. Water tests
                check contamination. Density tests verify standards. Pregnancy
                tests find paraffin. Visual inspections confirm clarity.
                Temperature checks verify proper fuel temperature. All tests
                must pass. Contaminated fuel never ships.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Your fleet depends on clean fuel, and your bottom line depends on
            reliability. Let's discuss your diesel supply requirements and
            discover how our quality-assured fuel can keep your operations
