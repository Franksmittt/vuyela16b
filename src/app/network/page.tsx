...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'The Vuyela Network | Vuyela Group',
    description:
      'Our strategic partnerships and logistics network across South Africa and beyond with TFR and shipping line connections.',
  ...
  twitter: {
    ...
    title: 'The Vuyela Network | Vuyela Group',
    description:
      'Strategic partnerships and relationships that power our logistics network across South Africa and beyond.',
  },
};
...
const networkPageSchema = {
  ...
  name: 'Vuyela Network',
  description:
    'Strategic logistics network with partnerships across South Africa and globally.',
  url: 'https://vuyela.com/network',
  memberOf: {
    '@type': 'Organization',
    name: 'Vuyela Group',
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-8 tracking-tight font-poppins">
            Our Global <span className="text-[#FFD700]">Network</span>
          </h1>

          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Strategic partnerships power our logistics network. Strong
            connections with TFR, shipping agents, road freight companies, and
            global partners ensure seamless operations. The Vuyela Network isn't
            just contacts. It's a carefully cultivated ecosystem of trusted
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Shipping
                    Line Access
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Road
                    Freight Network
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Vetted
                    Carriers
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Quality
                    Standards
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Proven
                    Track Record
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Shared
                    Commitment
                  </li>
                </ul>
              </div>
            ...
            {[
              {
                ...
                location: 'Gauteng',
                description: 'Main operations hub with SARS Bonded Warehouse',
              },
              {
                name: 'Port of Durban',
                location: 'KwaZulu-Natal',
                description: 'Primary port operations and container logistics',
              },
              {
                name: 'TFR Terminals',
                location: 'Nationwide',
                description: 'Strategic rail terminal access',
              },
            ].map((hub, index) => (
              <div
                key={index}
              ...
              {[
                {
                  icon: Truck,
                  value: 'Own Fleet',
                  label: 'Active Power Units',
                  description: 'Dedicated fleet operations',
                },
                {
                  icon: Warehouse,
                  value: '10,000+',
                ...
                },
                {
                  ...
                  value: '24/7',
                  label: 'Operations',
                  description: 'Never-stop logistics',
                },
              ].map((stat, index) => (
                <div
                  key={index}
                  className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a] text-center"
                >
                  ...
                  <p className="text-[#FFD700] text-sm font-medium mb-1">
                    {stat.label}
                  </p>
            ...
            {[
              {
                ...
                description:
                  'Internationally certified weighbridges meeting SOLAS standards for accurate cargo weighing and international shipping compliance.',
              ...
              },
              {
                ...
                description:
                  'Registered customs bond area providing secure storage with deferred duty payments, streamlined import/export processes.',
              ...
              },
              {
                ...
                description:
                  'Specialized infrastructure for handling bulk industrial bags, minerals, grain, and containerized cargo with precision.',
              ...
              },
              {
                ...
                description:
                  'Restricted access areas with security checkpoints ensuring cargo safety and compliance with international trade regulations.',
              ...
              <div
                key={index}
                className="bg-[#141414] rounded-lg overflow-hidden border border-[#222]"
              >
            ...
            {[
              {
                ...
                description:
                  'Live tracking systems providing complete visibility into cargo location and status throughout the supply chain.',
              },
              {
                icon: ShieldCheck,
                title: 'Full Yard Camera Coverage',
                description:
                  'Comprehensive CCTV surveillance system with 24/7 monitoring and recording capabilities for complete security visibility.',
              },
              {
                icon: FileText,
                title: 'Live System Monitoring',
                description:
                  'Continuous monitoring of operations, inventory, and cargo movements with real-time status updates and proactive issue resolution.',
              },
              {
                icon: Network,
                title: 'Integrated Network Systems',
                description:
                  'Seamless integration with TFR, shipping lines, and transport partners for coordinated logistics operations.',
              },
            ].map((feature, index) => (
              <div
                key={index}
            ...
            {[
              {
                ...
                description:
                  'Deep-rooted relationships with Transnet ensuring efficient rail logistics and terminal access.',
                icon: Route,
              },
              {
                ...
                description:
                  'Strategic partnerships with major shipping lines ensuring worldwide coverage for all customer requirements.',
                icon: Globe,
              },
              {
                ...
                description:
                  'Strong relationships with majority of registered road freight companies for seamless operations.',
                icon: Route,
              },
            ].map((partnership, index) => (
              <div
                key={index}
                className="bg-[#141414] rounded-lg p-6 border border-[#222]"
              >
                <div className="w-12 h-12 rounded-lg bg-[#FFD700] flex items-center justify-center mb-4">
        ...
        <section className="py-20 px-6 max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-base sm:text-lg max-w-2xl mx-auto">
              We partner with established, professional carriers who share our
              commitment to excellence. This application requires business
              documentation to ensure we work with serious, compliant operators.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                We select partners carefully. We require business documentation.
                We verify compliance. We check safety ratings. We review trade
                references. We only work with professional, compliant carriers
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Network partners get access to our client base. They benefit
                from our TFR relationships. They access our shipping line
                partnerships. They work with a company that values quality and
                reliability. They become part of a trusted logistics ecosystem.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                Applications are reviewed within 5-7 business days. We verify
                all documentation. We check references. We assess compliance. We
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                We have partnerships with Transnet Freight Rail. We work with
                major shipping lines. We partner with registered road freight
                companies. We have relationships with shipping agents and ship
                planners. These partnerships enable seamless logistics
                operations.
              </p>
            </div>
          </div>
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Benefit from our strategic partnerships and extensive logistics
            network. Contact us to see how we can connect your business to
