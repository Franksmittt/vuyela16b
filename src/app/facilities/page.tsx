...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Facilities | Vuyela Group',
    description:
      'State-of-the-art logistics facilities in Elandsfontein with SOLAS certified weighbridges and SARS bonded warehouse.',
...
const facilitiesPageSchema = {
  ...
  containsPlace: {
    ...
    description:
      'Main operations hub with SARS Bonded Warehouse and SOLAS certified weighbridges.',
  },
};
      ...
      <main className="bg-[#141414] min-h-screen font-sans text-gray-300">
        ...
        <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto border-b border-[#1f1f1f]">
          ...
          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl border-l-2 border-[#FFD700]/30 pl-6">
            Our infrastructure works efficiently. Security stays strong.
            Compliance gets met. Our Elandsfontein facility uses modern
            technology. Industry standards get followed. Service stays
            exceptional.
          </p>
        </section>
          ...
          <div className="px-6 max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 mt-4">
                We invest in infrastructure that delivers results.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-[#141414] p-8 rounded-xl border border-[#222]">
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> 24/7
                    Monitoring
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#FFD700]" /> Security
                    Guard Patrols
                  </li>
                </ul>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-stretch">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                We're located on Main Reef Road. Our facility is the heart of
                Vuyela Group. SOLAS certified weighbridges ensure international
                compliance. SARS Bonded Warehouse status helps customs. CCTV
                cameras monitor 24/7. Every part supports your logistics needs.
              </p>
              <p className="text-gray-400 leading-relaxed mb-6">
                We handle bulk commodity storage. Containerization works
                smoothly. Road freight coordination happens here. Everything
                works under one roof. Reliability and security stay guaranteed.
              </p>
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  Strategic location for transport routes
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  Close to Port of Durban
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#FFD700] flex-shrink-0 mt-0.5" />{' '}
                  Near TFR terminals
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
                ...
                <p className="text-gray-400 leading-relaxed mb-4">
                  Our workshop maintains our fleet. Trucks get serviced
                  regularly. Repairs happen quickly. Equipment stays maintained.
              ...
              <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
                ...
                <p className="text-gray-400 leading-relaxed mb-4">
                  Our wash bay cleans trucks. Containers get washed before
                  export. Equipment stays clean. Standards get met. Presentation
                  stays professional.
                </p>
                <ul className="space-y-2 text-gray-300 text-sm">
                  <li className="flex gap-2">
              ...
              <div className="bg-[#141414] rounded-lg p-6 border border-[#2a2a2a]">
                ...
                <p className="text-gray-400 leading-relaxed mb-4">
                  Security protects our depot. Access gets controlled. CCTV
                  monitors everything. Guards patrol regularly. Cargo stays
                  safe.
                </p>
                <ul className="space-y-2 text-gray-300 text-sm">
                  <li className="flex gap-2">
            ...
            {[
              {
                ...
                description:
                  'Our weighbridges meet SOLAS standards. They weigh cargo accurately. International shipping accepts these weights. No disputes happen.',
                benefits: [
              ...
              },
              {
                ...
                description:
                  'We are a SARS bonded warehouse. Duty payments get deferred. Secure storage works here. Customs compliance stays guaranteed.',
                benefits: [
              ...
              },
              {
                ...
                description:
                  'CCTV cameras cover our entire facility. Monitoring happens 24/7. Recording captures everything. Security stays visible.',
                benefits: [
              ...
              },
              {
                ...
                description:
                  'Our facility operates 24/7. Service stays available always. We respond to client needs quickly. No downtime delays happen.',
                benefits: [
                  'No downtime delays',
                  'Flexible scheduling',
              ...
              },
              {
                ...
                description:
                  'We follow NOSA safety standards. Workplace safety stays guaranteed. Operations stay excellent. Workers stay protected.',
                benefits: [
              ...
              },
              {
                ...
                description:
                  'Our tracking systems work in real-time. You see operations clearly. Inventory stays visible. Cargo movements get tracked.',
                benefits: [
              ...
              },
              {
                ...
                description:
                  'We pack containers professionally. Six-meter and twelve-meter containers work fine. Handling stays proper. Documentation stays correct.',
                benefits: [
              ...
              },
              {
                ...
                description:
                  'We provide custom bagging services. Different commodities get different bags. Customer requirements get met. Specifications stay followed.',
                benefits: [
              ...
              },
              {
                ...
                description:
                  'Dedicated warehouse space for stockpiling and storage of bulk commodities with optimal organization and accessibility.',
                benefits: [
              ...
              <div
                key={index}
                className="bg-[#141414] rounded-xl p-6 border border-[#222]"
              >
            ...
            {[
              {
                ...
                description:
                  'Multi-layered security systems protecting your valuable cargo at every stage.',
              },
              {
                icon: FileCheck,
                title: 'Compliance Guaranteed',
                description:
                  'All facilities meet and exceed industry standards and regulatory requirements.',
              },
              {
                icon: Zap,
                title: 'Operational Excellence',
                description:
                  'State-of-the-art infrastructure designed for maximum efficiency and reliability.',
              },
              {
                icon: Eye,
                title: 'Transparent Operations',
                description:
                  'Complete visibility into all operations through live tracking and monitoring systems.',
              },
            ].map((feature, index) => (
              <div
                key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Our facilities have multiple certifications. SOLAS certified
                weighbridges ensure international shipping compliance. SARS
                Bonded Warehouse status allows deferred duty payments. NOSA
                safety standards protect workers. ISO compliance ensures quality
                operations.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Our facility is highly secure. CCTV cameras cover the entire
                yard. Monitoring happens 24/7. Access is controlled through
                gates. Security guards patrol regularly. Alarm systems protect
            ...
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              ...
              <p className="text-sm text-gray-400">
                Yes. We welcome facility visits by appointment. Schedule a tour
                to see our operations. You'll see our weighbridges, warehouse,
                and security systems. Our team will answer all your questions.
              </p>
            </div>
            <div className="bg-[#141414] p-6 rounded-lg border border-[#2a2a2a]">
              <h3 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-400">
                Our facility offers multiple services. We handle bulk commodity
                storage. We provide containerization. We offer bagging services.
                We coordinate road freight. We maintain our fleet. Everything
        ...
        <section className="py-20 bg-[#141414] text-center px-6">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            See firsthand how our world-class infrastructure can support your
            logistics needs. Schedule a facility tour or contact us to learn
            more.
          </p>
